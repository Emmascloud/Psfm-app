      ...
      <div className="rounded-2xl bg-paper p-8">
        ...
        {suspended && (
          <p className="font-body text-sm text-ember bg-ember/10 rounded-lg px-3 py-2 mb-4">
            This account has been suspended. Contact an admin if you think
            that's a mistake.
          </p>
        )}
        ...
        <form action={formAction} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <label className="font-body text-sm text-ink-on-paper/70" htmlFor="password">
                Password
              </label>
              <Link href="/forgot-password" className="font-body text-xs text-marigold hover:underline">
                Forgot password?
              </Link>
            </div>
            <input
